...
public class ArgumentSetterDouble implements ArgumentSetter<Double>
{

	@Override
	public void setArguments(IPreparedStatement stmt, int index, Double object)
			throws QueryException
	{
		stmt.setDouble(index, object);
	}
